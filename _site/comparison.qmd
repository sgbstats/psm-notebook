...
in_sample_psm=test %>% lm(exac_modsev_n~fit, data=.) %>% survival::concordance()

newdata=data %>% filter(!train)
test=predict.submodels(newdata=newdata, submodels.object = submodels.object, se.fit=T,retain_lhs = T,include_mp=T, type='response')

out_sample_psm=test %>% lm(exac_modsev_n~fit, data=.) %>% survival::concordance()
...
in_sample_ri=test %>% lm(exac_modsev_n~fit, data=.) %>% survival::concordance()
...
out_sample_ri=test %>% lm(exac_modsev_n~fit, data=.) %>% survival::concordance()
...
in_sample_rf=test %>% lm(exac_modsev_n~fit, data=.) %>% survival::concordance()
...
out_sample_rf=test %>% lm(exac_modsev_n~fit, data=.) %>% survival::concordance()
